...
/*   Updated: 2022/08/07 18:08:45 by mtellal          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(int isSigned, std::string nameForm, std::string reason) const
{
	if (isSigned)
		std::cout << this->getName() << " sigend " << nameForm << std::endl;
	else
		std::cout << this->getName() << " couldn't sign " << nameForm << " because " << reason << std::endl;
}
